...
function sideMenu() {
  ...
  var side = 0; // Declare and initialize side inside the function

  if (side == 0) {
    menu.style = "transform: translateX(0vh); position:fixed;";
  } else {
    menu.style = "transform: translateX(-100%);";
    side = 0; // Reset side to 0 when the menu is closed
  }
...
if (userEmail) {
  ...
  // You can use userEmail in your application as needed
} else {
  // Email is not present in local storage
